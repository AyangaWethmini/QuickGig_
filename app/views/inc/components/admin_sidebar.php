<?php require APPROOT . '/views/inc/header.php'; ?>
    <div class="admin-sidebar">
        <div class="signup_logo">
            <img src="<?php echo ROOT; ?>/public/assets/img/logo.png" alt="Description of image">
        </div>
        <div class="admin-anchor-list">
            ...
            <a href="<?php echo ROOT; ?>/admin/adminmanageusers" class="<?php echo (strpos($_SERVER['REQUEST_URI'], '/admin/adminmanageusers') !== false) ? 'active' : ''; ?>"><i class="fa-solid fa-user" style="padding-right: 3px;"></i>Manage Users</a>
            <br><hr><br>
