    ...
    <div class="wrapper flex-row">
        ...
        <div class="inclusion-container">
            ...
            <div class="list-header">
                <p class="list-header-title">Incompleted List</p>
                            ...
                            <div class="employee-photo">
                                <div class="img">
                                    <?php if ($completed->pp): ?>
                                        ...
                                        ?>
                                        <a href="<?= ROOT ?>/jobProvider/viewEmployeeProfile/<?= $completed->accountID ?>">
...
<script>
    document.querySelector('.search-input').addEventListener('input', function() {
        ...
        fetch(`<?= ROOT ?>/jobProvider/jobListing_notDone?search=${encodeURIComponent(searchTerm)}`)
    ...
    function filterByDate(selectedDate) {
        ...
        fetch(`<?= ROOT ?>/jobProvider/jobListing_notDone?filterDate=${encodeURIComponent(selectedDate)}`)
            .then(response => response.text())
            .then(html => {
                const parser = new DOMParser();
                const doc = parser.parseFromString(html, 'text/html');
