...
<div class="wrapper flex-row">
    ...
    <div class="inclusion-container">
        ...
        <div class="category-container">
            <div class="category">My Jobs (2)</div>
            <div class="category">Received (45)</div>
            <div class="category">Send (30)</div>
            <div class="category">To be completed (18)</div>
            <div class="category">Ongoing (5)</div>
            <div class="category">Completed (2)</div>
        </div> <hr> <br>
