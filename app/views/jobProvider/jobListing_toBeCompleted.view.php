                        ...
                        <div class="employee-item">
                            <div class="employee-photo">
                                <div class="img">
                                    <?php if ($tbc->pp): ?>
                                        ...
                                        ?>
                                        <a href="<?= ROOT ?>/jobProvider/viewEmployeeProfile/<?= $tbc->accountID ?>">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?= ROOT ?>/jobProvider/viewEmployeeProfile/<?= $tbc->accountID ?>">View Profile</a></li>
                                </ul>
                            </div>
                        </div>
                    <?php endforeach; ?>
                    ...
                    <?php foreach ($data['reqAvailableTBC'] as $tbc): ?>
                        ...
                        <div class="employee-item">
                            ...
                            <div class="dropdown">
                                <button class="dropdown-toggle"><i class="fa-solid fa-ellipsis-vertical"></i></button>
                                <ul class="dropdown-menu">
                                    <li><a href="<?= ROOT ?>/jobProvider/viewEmployeeProfile/<?= $tbc->accountID ?>">
                                            View Profile</a></li>
                                </ul>
                            </div>
                        </div>
...
<script>
    ...
    document.querySelector('.search-input').addEventListener('input', function() {
        ...
        fetch(`<?= ROOT ?>/jobProvider/jobListing_toBeCompleted?search=${encodeURIComponent(searchTerm)}`)
    ...
    function filterByDate(selectedDate) {
        ...
        fetch(`<?= ROOT ?>/jobProvider/jobListing_toBeCompleted?filterDate=${encodeURIComponent(selectedDate)}`)
            .then(response => response.text())
            .then(html => {
                const parser = new DOMParser();
                const doc = parser.parseFromString(html, 'text/html');
