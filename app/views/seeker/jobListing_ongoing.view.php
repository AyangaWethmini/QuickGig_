...
<div class="wrapper flex-row">
    ...
    <div class="inclusion-container">
        ...
        <div class="list-header">
            ...
            <form method="GET" action="<?= ROOT ?>/seeker/jobListing_ongoing">
        ...
        <div class="employee-item">
                ...
                <div class="employee-details">
                    <span class="employee-name"><?= htmlspecialchars($ongoing->name) ?></span>
        ...
        <?php if (empty($data['reqAvailableOngoing']) && empty($data['applyJobOngoing'])): ?>
...
document.querySelector('.search-input').addEventListener('input', function () {
        ...
        fetch(`<?= ROOT ?>/seeker/jobListing_ongoing?search=${encodeURIComponent(searchTerm)}`)
