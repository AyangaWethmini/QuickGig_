                        ...
                        <div class="employee-item">
                            ...
                            <div class="employee-photo">
                                <div class="img">
                                    <?php if ($ongoing->pp): ?>
                                        ...
                                        ?>
                                        <a href="<?= ROOT ?>/organization/org_viewEmployeeProfile/<?= $ongoing->accountID ?>">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?= ROOT ?>/organization/org_viewEmployeeProfile/<?= $ongoing->accountID ?>">View Profile</a></li>
                                </ul>
                            </div>
                        </div>
                    <?php endforeach; ?>
...
<script>
    ...
    document.querySelector('.search-input').addEventListener('input', function() {
        ...
        fetch(`<?= ROOT ?>/organization/org_jobListing_ongoing?search=${encodeURIComponent(searchTerm)}`)
    ...
    function filterByDate(selectedDate) {
        ...
        fetch(`<?= ROOT ?>/organization/org_jobListing_ongoing?filterDate=${encodeURIComponent(selectedDate)}`)
            .then(response => response.text())
            .then(html => {
                const parser = new DOMParser();
                const doc = parser.parseFromString(html, 'text/html');
